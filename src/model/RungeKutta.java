...
public class RungeKutta {
    ...
    public double runge(BiFunction<Double, Double, Double> yp_func, yinit, double dt) {
        double dy1 = dt * yp_func.apply(yinit);
        double dy2 = dt * yp_func.apply(dt / 2.0, y[n] + dy1 / 2.0);
        double dy3 = dt * yp_func.apply(t[n] + dt / 2.0, y[n] + dy2 / 2.0);
        double dy4 = dt * yp_func.apply(t[n] + dt, y[n] + dy3);
        y[n + 1] = y[n] + (dy1 + 2.0 * (dy2 + dy3) + dy4) / 6.0;
    }
