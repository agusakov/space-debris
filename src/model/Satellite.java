...
public class Satellite extends SpaceObject implements Serializable {
	...
	*/
	public Satellite(int originX, int originY, double xOffset, double yOffset, int xVel, int yVel, int frameWidth, int frameHeight, int imgWidth, int imgHeight, double mass) {
		this.name = "Earth";
